...
CREATE TABLE employees (
    ...
    --CONSTRAINT employees_idx_1 UNIQUE (reportsTo),
...
CREATE TABLE customers (
    ...
    --CONSTRAINT customes_idx_1 UNIQUE (salesRepEmployeeNumber),
...
CREATE TABLE products (
    ...
    --CONSTRAINT products_idx1 UNIQUE (productLine),
...
CREATE TABLE orders (
    ...
    --CONSTRAINT orders_idx_1 UNIQUE (customerNumber),
...
CREATE TABLE orderdetails (
    ...
    --CONSTRAINT orderdetails_idx_1 UNIQUE (productCode),
...
insert  into customers(customerNumber,customerName,contactLastName,contactFirstName,phone,addressLine1,addressLine2,city,state,postalCode,country,salesRepEmployeeNumber,creditLimit) values
    ...
    (144,'Volvo Model Replicas, Co','Berglund','Christina ','0921-12 3555','BerguvsvÃ¤gen  8',NULL,'LuleÃ¥',NULL,'S-958 22','Sweden',1504,53100.00),

    (145,'Danish Wholesale Imports','Petersen','Jytte ','31 12 3555','VinbÃ¦ltet 34',NULL,'Kobenhavn',NULL,'1734','Denmark',1401,83400.00),
    ...
    (169,'Porto Imports Co.','de Castro','Isabel ','(1) 356-5555','Estrada da saÃºde n. 58',NULL,'Lisboa',NULL,'1756','Portugal',NULL,0.00),

    (171,'Daedalus Designs Imports','RancÃ©','Martine ','20.16.1555','184, chaussÃ©e de Tournai',NULL,'Lille',NULL,'59000','France',1370,82900.00),
    ...
    (209,'Mini Caravy','Citeaux','FrÃ©dÃ©rique ','88.60.1555','24, place KlÃ©ber',NULL,'Strasbourg',NULL,'67000','France',1370,53800.00),
    ...
    (216,'Enaco Distributors','Saavedra','Eduardo ','(93) 203 4555','Rambla de CataluÃ±a, 23',NULL,'Barcelona',NULL,'08022','Spain',1702,60300.00),

    (219,'Boards & Toys Co.','Young','Mary','3105552373','4097 Douglas Av.',NULL,'Glendale','CA','92561','USA',1166,11000.00),

    (223,'NatÃ¼rlich Autos','Kloss','Horst ','0372-555188','TaucherstraÃŸe 10',NULL,'Cunewalde',NULL,'01307','Germany',NULL,0.00),

    (227,'Heintze Collectables','Ibsen','Palle','86 21 3555','Smagsloget 45',NULL,'Ã…rhus',NULL,'8200','Denmark',1401,120800.00),

    (233,'QuÃ©bec Home Shopping Network','FresniÃ¨re','Jean ','(514) 555-8054','43 rue St. Laurent',NULL,'MontrÃ©al','QuÃ©bec','H1J 1C3','Canada',1286,48700.00),

    (237,'ANG Resellers','Camino','Alejandra ','(91) 745 6555','Gran VÃ­a, 1',NULL,'Madrid',NULL,'28001','Spain',NULL,0.00),
    ...
    (256,'Auto AssociÃ©s & Cie.','Tonini','Daniel ','30.59.8555','67, avenue de l''Europe',NULL,'Versailles',NULL,'78000','France',1370,77900.00),

    (259,'Toms SpezialitÃ¤ten, Ltd','Pfalzheim','Henriette ','0221-5554327','Mehrheimerstr. 369',NULL,'KÃ¶ln',NULL,'50739','Germany',1504,120400.00),
    ...
    (273,'Franken Gifts, Co','Franken','Peter ','089-0877555','Berliner Platz 43',NULL,'MÃ¼nchen',NULL,'80805','Germany',NULL,0.00),
    ...
    (298,'Vida Sport, Ltd','Holz','Mihael','0897-034555','Grenzacherweg 237',NULL,'GenÃ¨ve',NULL,'1203','Switzerland',1702,141300.00),
    ...
    (335,'Cramer SpezialitÃ¤ten, Ltd','Cramer','Philip ','0555-09555','Maubelstr. 90',NULL,'Brandenburg',NULL,'14776','Germany',NULL,0.00),
    ...
    (361,'Kommission Auto','Josephs','Karin','0251-555259','Luisenstr. 48',NULL,'MÃ¼nster',NULL,'44087','Germany',NULL,0.00),
    ...
    (409,'Stuttgart Collectable Exchange','MÃ¼ller','Rita ','0711-555361','Adenauerallee 900',NULL,'Stuttgart',NULL,'70563','Germany',NULL,0.00),
    ...
    (448,'Scandinavian Gift Ideas','Larsson','Martha','0695-34 6555','Ã…kergatan 24',NULL,'BrÃ¤cke',NULL,'S-844 67','Sweden',1504,116400.00),
    ...
    (458,'Corrida Auto Replicas, Ltd','Sommer','MartÃ­n ','(91) 555 22 82','C/ Araquil, 67',NULL,'Madrid',NULL,'28023','Spain',1702,104600.00),
    ...
    (477,'Mit VergnÃ¼gen & Co.','Moos','Hanna ','0621-08555','Forsterstr. 57',NULL,'Mannheim',NULL,'68306','Germany',NULL,0.00),
    ...
    (484,'Iberia Gift Imports, Corp.','Roel','JosÃ© Pedro ','(95) 555 82 82','C/ Romero, 33',NULL,'Sevilla',NULL,'41101','Spain',1702,65700.00),
...
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values
    ...
    (119,'DB933704','2014-11-14',19501.82),

    (119,'LN373447','2014-08-08',47924.19),

    (119,'NG94694','2015-02-22',49523.67),

    (121,'DB889831','2013-02-16',50218.95),

    (121,'FD317790','2013-10-28',1491.38),

    (121,'KI831359','2014-11-04',17876.32),

    (121,'MA302151','2014-11-28',34638.14),

    (124,'AE215433','2015-03-05',101244.59),

    (124,'BG255406','2014-08-28',85410.87),

    (124,'CQ287967','2013-04-11',11044.30),

    (124,'ET64396','2015-04-16',83598.04),

    (124,'HI366474','2014-12-27',47142.70),

    (124,'HR86578','2014-11-02',55639.66),

    (124,'KI131716','2013-08-15',111654.40),

    (124,'LF217299','2014-03-26',43369.30),

    (124,'NT141748','2013-11-25',45084.38),

    (128,'DI925118','2013-01-28',10549.01),

    (128,'FA465482','2013-10-18',24101.81),

    (128,'FH668230','2014-03-24',33820.62),

    (128,'IP383901','2014-11-18',7466.32),

    (129,'DM826140','2014-12-08',26248.78),

    (129,'ID449593','2013-12-11',23923.93),

    (129,'PI42991','2013-04-09',16537.85),

    (131,'CL442705','2013-03-12',22292.62),

    (131,'MA724562','2014-12-02',50025.35),

    (131,'NB445135','2014-09-11',35321.97),

    (141,'AU364101','2013-07-19',36251.03),

    (141,'DB583216','2014-11-01',36140.38),

    (141,'DL460618','2015-05-19',46895.48),

    (141,'HJ32686','2014-01-30',59830.55),

    (141,'ID10962','2014-12-31',116208.40),

    (141,'IN446258','2015-03-25',65071.26),

    (141,'JE105477','2015-03-18',120166.58),

    (141,'JN355280','2013-10-26',49539.37),

    (141,'JN722010','2013-02-25',40206.20),

    (141,'KT52578','2013-12-09',63843.55),

    (141,'MC46946','2014-07-09',35420.74),

    (141,'MF629602','2014-08-16',20009.53),

    (141,'NU627706','2014-05-17',26155.91),

    (144,'IR846303','2014-12-12',36005.71),

    (144,'LA685678','2013-04-09',7674.94),

    (145,'CN328545','2014-07-03',4710.73),

    (145,'ED39322','2014-04-26',28211.70),

    (145,'HR182688','2014-12-01',20564.86),

    (145,'JJ246391','2013-02-20',53959.21),

    (146,'FP549817','2014-03-18',40978.53),

    (146,'FU793410','2014-01-16',49614.72),

    (146,'LJ160635','2013-12-10',39712.10),

    (148,'BI507030','2013-04-22',44380.15),

    (148,'DD635282','2014-08-11',2611.84),

    (148,'KM172879','2013-12-26',105743.00),

    (148,'ME497970','2015-03-27',3516.04),

    (151,'BF686658','2013-12-22',58793.53),

    (151,'GB852215','2014-07-26',20314.44),

    (151,'IP568906','2013-06-18',58841.35),

    (151,'KI884577','2014-12-14',39964.63),

    (157,'HI618861','2014-11-19',35152.12),

    (157,'NN711988','2014-09-07',63357.13),

    (161,'BR352384','2014-11-14',2434.25),

    (161,'BR478494','2013-11-18',50743.65),

    (161,'KG644125','2015-02-02',12692.19),

    (161,'NI908214','2013-08-05',38675.13),

    (166,'BQ327613','2014-09-16',38785.48),

    (166,'DC979307','2014-07-07',44160.92),

    (166,'LA318629','2014-02-28',22474.17),

    (167,'ED743615','2014-09-19',12538.01),

    (167,'GN228846','2013-12-03',85024.46),

    (171,'GB878038','2014-03-15',18997.89),

    (171,'IL104425','2013-11-22',42783.81),

    (172,'AD832091','2014-09-09',1960.80),

    (172,'CE51751','2014-12-04',51209.58),

    (172,'EH208589','2013-04-20',33383.14),

    (173,'GP545698','2014-05-13',11843.45),

    (173,'IG462397','2014-03-29',20355.24),

    (175,'CITI3434344','2015-05-19',28500.78),

    (175,'IO448913','2013-11-19',24879.08),

    (175,'PI15215','2014-07-10',42044.77),

    (177,'AU750837','2014-04-17',15183.63),

    (177,'CI381435','2014-01-19',47177.59),

    (181,'CM564612','2014-04-25',22602.36),

    (181,'GQ132144','2013-01-30',5494.78),

    (181,'OH367219','2014-11-16',44400.50),

    (186,'AE192287','2015-03-10',23602.90),

    (186,'AK412714','2013-10-27',37602.48),

    (186,'KA602407','2014-10-21',34341.08),

    (187,'AM968797','2014-11-03',52825.29),

    (187,'BQ39062','2014-12-08',47159.11),

    (187,'KL124726','2013-03-27',48425.69),

    (189,'BO711618','2014-10-03',17359.53),

    (189,'NM916675','2014-03-01',32538.74),

    (198,'FI192930','2014-12-06',9658.74),

    (198,'HQ920205','2013-07-06',6036.96),

    (198,'IS946883','2014-09-21',5858.56),

    (201,'DP677013','2013-10-20',23908.24),

    (201,'OO846801','2014-06-15',37258.94),

    (202,'HI358554','2013-12-18',36527.61),

    (202,'IQ627690','2014-11-08',33594.58),

    (204,'GC697638','2014-08-13',51152.86),

    (204,'IS150005','2014-09-24',4424.40),

    (205,'GL756480','2013-12-04',3879.96),

    (205,'LL562733','2013-09-05',50342.74),

    (205,'NM739638','2015-02-06',39580.60),

    (209,'BOAF82044','2015-05-03',35157.75),

    (209,'ED520529','2014-06-21',4632.31),

    (209,'PH785937','2014-05-04',36069.26),

    (211,'BJ535230','2013-12-09',45480.79),

    (216,'BG407567','2013-05-09',3101.40),

    (216,'ML780814','2014-12-06',24945.21),

    (216,'MM342086','2013-12-14',40473.86),

    (219,'BN17870','2015-03-02',3452.75),

    (219,'BR941480','2013-10-18',4465.85),

    (227,'MQ413968','2013-10-31',36164.46),

    (227,'NU21326','2014-11-02',53745.34),

    (233,'BOFA23232','2015-05-20',29070.38),

    (233,'II180006','2014-07-01',22997.45),

    (233,'JG981190','2013-11-18',16909.84),

    (239,'NQ865547','2014-03-15',80375.24),

    (240,'IF245157','2014-11-16',46788.14),

    (240,'JO719695','2014-03-28',24995.61),

    (242,'AF40894','2013-11-22',33818.34),

    (242,'HR224331','2015-06-03',12432.32),

    (242,'KI744716','2013-07-21',14232.70),

    (249,'IJ399820','2014-09-19',33924.24),

    (249,'NE404084','2014-09-04',48298.99),

    (250,'EQ12267','2015-05-17',17928.09),

    (250,'HD284647','2014-12-30',26311.63),

    (250,'HN114306','2013-07-18',23419.47),

    (256,'EP227123','2014-02-10',5759.42),

    (256,'HE84936','2014-10-22',53116.99),

    (259,'EU280955','2014-11-06',61234.67),

    (259,'GB361972','2013-12-07',27988.47),

    (260,'IO164641','2014-08-30',37527.58),

    (260,'NH776924','2014-04-24',29284.42),

    (276,'EM979878','2015-02-09',27083.78),

    (276,'KM841847','2013-11-13',38547.19),

    (276,'LE432182','2013-09-28',41554.73),

    (276,'OJ819725','2015-04-30',29848.52),

    (278,'BJ483870','2014-12-05',37654.09),

    (278,'GP636783','2013-03-02',52151.81),

    (278,'NI983021','2013-11-24',37723.79),

    (282,'IA793562','2013-08-03',24013.52),

    (282,'JT819493','2014-08-02',35806.73),

    (282,'OD327378','2015-01-03',31835.36),

    (286,'DR578578','2014-10-28',47411.33),

    (286,'KH910279','2014-09-05',43134.04),

    (298,'AJ574927','2014-03-13',47375.92),

    (298,'LF501133','2014-09-18',61402.00),

    (299,'AD304085','2013-10-24',36798.88),

    (299,'NR157385','2014-09-05',32260.16),

    (311,'DG336041','2015-02-15',46770.52),

    (311,'FA728475','2013-10-06',32723.04),

    (311,'NQ966143','2014-04-25',16212.59),

    (314,'LQ244073','2014-08-09',45352.47),

    (314,'MD809704','2014-03-03',16901.38),

    (319,'HL685576','2014-11-06',42339.76),

    (319,'OM548174','2013-12-07',36092.40),

    (320,'GJ597719','2015-01-18',8307.28),

    (320,'HO576374','2013-08-20',41016.75),

    (320,'MU817160','2013-11-24',52548.49),

    (321,'DJ15149','2013-11-03',85559.12),

    (321,'LA556321','2015-03-15',46781.66),

    (323,'AL493079','2015-05-23',75020.13),

    (323,'ES347491','2014-06-24',37281.36),

    (323,'HG738664','2013-07-05',2880.00),

    (323,'PQ803830','2014-12-24',39440.59),

    (324,'DQ409197','2014-12-13',13671.82),

    (324,'FP443161','2013-07-07',29429.14),

    (324,'HB150714','2013-11-23',37455.77),

    (328,'EN930356','2014-04-16',7178.66),

    (328,'NR631421','2014-05-30',31102.85),

    (333,'HL209210','2013-11-15',23936.53),

    (333,'JK479662','2013-10-17',9821.32),

    (333,'NF959653','2015-03-01',21432.31),

    (334,'CS435306','2015-01-27',45785.34),

    (334,'HH517378','2013-08-16',29716.86),

    (334,'LF737277','2014-05-22',28394.54),

    (339,'AP286625','2014-10-24',23333.06),

    (339,'DA98827','2013-11-28',34606.28),

    (344,'AF246722','2013-11-24',31428.21),

    (344,'NJ906924','2014-04-02',15322.93),

    (347,'DG700707','2014-01-18',21053.69),

    (347,'LG808674','2013-10-24',20452.50),

    (350,'BQ602907','2014-12-11',18888.31),

    (350,'CI471510','2013-05-25',50824.66),

    (350,'OB648482','2015-01-29',1834.56),

    (353,'CO351193','2015-01-10',49705.52),

    (353,'ED878227','2013-07-21',13920.26),

    (353,'GT878649','2013-05-21',16700.47),

    (353,'HJ618252','2015-06-09',46656.94),

    (357,'AG240323','2013-12-16',20220.04),

    (357,'NB291497','2014-05-15',36442.34),

    (362,'FP170292','2014-07-11',18473.71),

    (362,'OG208861','2014-09-21',15059.76),

    (363,'HL575273','2014-11-17',50799.69),

    (363,'IS232033','2013-01-16',10223.83),

    (363,'PN238558','2013-12-05',55425.77),

    (379,'CA762595','2015-02-12',28322.83),

    (379,'FR499138','2013-09-16',32680.31),

    (379,'GB890854','2014-08-02',12530.51),

    (381,'BC726082','2014-12-03',12081.52),

    (381,'CC475233','2013-04-19',1627.56),

    (381,'GB117430','2015-02-03',14379.90),

    (381,'MS154481','2013-08-22',1128.20),

    (382,'CC871084','2013-05-12',35826.33),

    (382,'CT821147','2014-08-01',6419.84),

    (382,'PH29054','2014-11-27',42813.83),

    (385,'BN347084','2013-12-02',20644.24),

    (385,'CP804873','2014-11-19',15822.84),

    (385,'EK785462','2013-03-09',51001.22),

    (386,'DO106109','2013-11-18',38524.29),

    (386,'HG438769','2014-07-18',51619.02),

    (398,'AJ478695','2015-02-14',33967.73),

    (398,'DO787644','2014-06-21',22037.91),

    (398,'JPMR4544','2015-05-18',615.45),

    (398,'KB54275','2014-11-29',48927.64),

    (406,'BJMPR4545','2015-04-23',12190.85),

    (406,'HJ217687','2014-01-28',49165.16),

    (406,'NA197101','2014-06-17',25080.96),

    (412,'GH197075','2014-07-25',35034.57),

    (412,'PJ434867','2014-04-14',31670.37),

    (415,'ER54537','2014-09-28',31310.09),

    (424,'KF480160','2014-12-07',25505.98),

    (424,'LM271923','2013-04-16',21665.98),

    (424,'OA595449','2013-10-31',22042.37),

    (447,'AO757239','2013-09-15',6631.36),

    (447,'ER615123','2013-06-25',17032.29),

    (447,'OU516561','2014-12-17',26304.13),

    (448,'FS299615','2015-04-18',27966.54),

    (448,'KR822727','2014-09-30',48809.90),

    (450,'EF485824','2014-06-21',59551.38),

    (452,'ED473873','2013-11-15',27121.90),

    (452,'FN640986','2013-11-20',15130.97),

    (452,'HG635467','2015-05-03',8807.12),

    (455,'HA777606','2013-12-05',38139.18),

    (455,'IR662429','2014-05-12',32239.47),

    (456,'GJ715659','2014-11-13',27550.51),

    (456,'MO743231','2014-04-30',1679.92),

    (458,'DD995006','2014-11-15',33145.56),

    (458,'NA377824','2014-02-06',22162.61),

    (458,'OO606861','2013-06-13',57131.92),

    (462,'ED203908','2015-04-15',30293.77),

    (462,'GC60330','2013-11-08',9977.85),

    (462,'PE176846','2014-11-27',48355.87),

    (471,'AB661578','2014-07-28',9415.13),

    (471,'CO645196','2013-12-10',35505.63),

    (473,'LL427009','2014-02-17',7612.06),

    (473,'PC688499','2013-10-27',17746.26),

    (475,'JP113227','2013-12-09',7678.25),

    (475,'PB951268','2014-02-13',36070.47),

    (484,'GK294076','2014-10-26',3474.66),

    (484,'JH546765','2013-11-29',47513.19),

    (486,'BL66528','2014-04-14',5899.38),

    (486,'HS86661','2014-11-23',45994.07),

    (486,'JB117768','2013-03-20',25833.14),

    (487,'AH612904','2013-09-28',29997.09),

    (487,'PT550181','2014-02-28',12573.28),

    (489,'OC773849','2013-12-04',22275.73),

    (489,'PO860906','2014-01-31',7310.42),

    (495,'BH167026','2013-12-26',59265.14),

    (495,'FN155234','2014-05-14',6276.60),

    (496,'EU531600','2015-05-25',30253.75),

    (496,'MB342426','2013-07-16',32077.44),

    (496,'MN89921','2014-12-31',52166.00);
...
insert  into products(productCode,productName,productLine,productScale,productVendor,productDescription,quantityInStock,buyPrice,MSRP) values
    ...
    ('S32_1268','1980â€™s GM Manhattan Express','Trucks and Buses','1:32','Motor City Art Classics','This 1980â€™s era new look Manhattan express is still active, running from the Bronx to mid-town Manhattan. Has 35 opeining windows and working lights. Needs a battery.',5099,53.93,96.31),
...
insert  into orders(orderNumber,orderDate,requiredDate,shippedDate,status,comments,customerNumber) values
    ...
    (10118,'2013-04-21','2013-04-29','2013-04-26','Shipped','Customer has worked with some of our vendors in the past and is aware of their MSRP',216),
    ...
    (10124,'2013-05-21','2013-05-29','2013-05-25','Shipped','Customer very concerned about the exact color of the models. There is high risk that he may dispute the order because there is a slight color mismatch',112),
    ...
    (10136,'2013-07-04','2013-07-14','2013-07-06','Shipped','Customer is interested in buying more Ferrari models',242),
    ...
    (10143,'2013-08-10','2013-08-18','2013-08-12','Shipped','Can we deliver the new Ford Mustang models by end-of-quarter?',320),
    ...
    (10164,'2013-10-21','2013-10-30','2013-10-23','Resolved','This order was disputed, but resolved on 11/1/2003; Customer doesn''t like the colors and precision of the models.',452),
    ...
    (10173,'2013-11-05','2013-11-15','2013-11-09','Shipped','Cautious optimism. We have happy customers here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches',278),
    ...
    (10183,'2013-11-13','2013-11-22','2013-11-15','Shipped','We need to keep in close contact with their Marketing VP. He is the decision maker for all their purchases.',339),

    (10184,'2013-11-14','2013-11-22','2013-11-20','Shipped',NULL,484),

    (10185,'2013-11-14','2013-11-21','2013-11-20','Shipped',NULL,320),

    (10186,'2013-11-14','2013-11-20','2013-11-18','Shipped','They want to reevaluate their terms agreement with the VP of Sales',489),
    ...
    (10197,'2013-11-26','2013-12-02','2013-12-01','Shipped','Customer inquired about remote controlled models and gold models.',216),
    ...
    (10223,'2014-02-20','2014-02-28','2014-02-24','Shipped',NULL,114),

    (10224,'2014-02-21','2014-03-02','2014-02-26','Shipped','Customer has worked with some of our vendors in the past and is aware of their MSRP',171),
    ...
    (10230,'2014-03-15','2014-03-24','2014-03-20','Shipped','Customer very concerned about the exact color of the models. There is high risk that he may dispute the order because there is a slight color mismatch',128),
    ...
    (10242,'2014-04-20','2014-04-28','2014-04-25','Shipped','Customer is interested in buying more Ferrari models',456),
    ...
    (10249,'2014-05-08','2014-05-17','2014-05-11','Shipped','Can we deliver the new Ford Mustang models by end-of-quarter?',173),
    ...
    (10264,'2014-06-30','2014-07-06','2014-07-01','Shipped','Customer will send a truck to our local warehouse on 7/1/2004',362),
    ...
    (10279,'2014-08-09','2014-08-19','2014-08-15','Shipped','Cautious optimism. We have happy customers here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches',141),
    ...
    (10289,'2014-09-03','2014-09-13','2014-09-04','Shipped','We need to keep in close contact with their Marketing VP. He is the decision maker for all their purchases.',167),
    ...
    (10298,'2014-09-27','2014-10-05','2014-10-01','Shipped',NULL,103),
    ...
    (10303,'2014-10-06','2014-10-14','2014-10-09','Shipped','Customer inquired about remote controlled models and gold models.',484),
    ...
    (10322,'2014-11-04','2014-11-12','2014-11-10','Shipped','Customer has worked with some of our vendors in the past and is aware of their MSRP',363),
    ...
    (10327,'2014-11-10','2014-11-19','2014-11-13','Resolved','Order was disputed and resolved on 12/1/04. The Sales Manager was involved. Customer claims the scales of the models don''t match what was discussed.',145),

    (10328,'2014-11-12','2014-11-21','2014-11-18','Shipped','Customer very concerned about the exact color of the models. There is high risk that he may dispute the order because there is a slight color mismatch',278),
    ...
    (10334,'2014-11-19','2014-11-28',NULL,'On Hold','The outstaniding balance for this customer exceeds their credit limit. Order will be shipped when a payment is received.',144),
    ...
    (10340,'2014-11-24','2014-12-01','2014-11-25','Shipped','Customer is interested in buying more Ferrari models',216),
    ...
    (10347,'2014-11-29','2014-12-07','2014-11-30','Shipped','Can we deliver the new Ford Mustang models by end-of-quarter?',114),
    ...
    (10367,'2015-01-12','2015-01-21','2015-01-16','Resolved','This order was disputed and resolved on 2/1/2005. Customer claimed that container with shipment was damaged. FedEx''s investigation proved this wrong.',205),
    ...
    (10377,'2015-02-09','2015-02-21','2015-02-12','Shipped','Cautious optimism. We have happy customers here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches',186),
    ...
    (10386,'2015-03-01','2015-03-09','2015-03-06','Resolved','Disputed then Resolved on 3/15/2005. Customer doesn''t like the craftsmaship of the models.',141),

    (10387,'2015-03-02','2015-03-09','2015-03-06','Shipped','We need to keep in close contact with their Marketing VP. He is the decision maker for all their purchases.',148),
    ...
    (10415,'2015-05-09','2015-05-20','2015-05-12','Disputed','Customer claims the scales of the models don''t match what was discussed. I keep all the paperwork though to prove otherwise',471),

    (10416,'2015-05-10','2015-05-16','2015-05-14','Shipped',NULL,386),

    (10417,'2015-05-13','2015-05-19','2015-05-19','Disputed','Customer doesn''t like the colors and precision of the models.',141),
